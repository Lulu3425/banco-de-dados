...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12-Abr-2024 às 15:18
...
INSERT INTO `barbeiro` (`nome`, `id`, `numero`) VALUES
('Ricardo', 1, 'matematica');
...
--
-- Banco de dados: `loja_web`
--
CREATE DATABASE IF NOT EXISTS `loja_web` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `loja_web`;
...
INSERT INTO `item_pedido` (`id_item_pedido`, `quantidade`, `id_pedido`, `id_produto`) VALUES
(1, 1, 1, 1);
...
INSERT INTO `pedido` (`id_pedido`, `data`, `id_pessoa`) VALUES
(1, '2025-03-28', 12);
...
(1, 'QuantumTech X7 Smartphone'),
(2, 'CyberLink Pro Gaming Mouse'),
(3, 'NovaStream VR Headset'),
(4, 'QuantumFusion Quantum Processor'),
(5, 'UltraSync Smartwatch'),
(6, 'QuantumGlide Mechanical Keyboard'),
(7, 'PhotonDrive Solid State Drive'),
(8, 'HyperFlow Gaming Router'),
(9, 'TitanX Ultimate Graphics Card'),
(10, 'iphone 6 plus'),
(11, 'Processador'),
(12, 'ideapad'),
(13, 'ryzen5500u'),
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoa` (`id_pessoa`);
--
...
('root', '2024-04-12 13:18:18', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
